...
bool Buffer::operator==(const Buffer& v) const { return v.m_buffer == m_buffer; }
bool Buffer::operator!=(const Buffer& v) const { return v.m_buffer != m_buffer; }
bool Buffer::valid() const { return m_buffer != nullptr; }
ID3D11Buffer* Buffer::ptr() { return m_buffer.get(); }
ID3D11ShaderResourceView* Buffer::srv() { return m_srv.get(); }
ID3D11UnorderedAccessView* Buffer::uav() { return m_uav.get(); }
int Buffer::getSize() const { return m_size; }
int Buffer::getStride() const { return m_stride; }
...
bool Texture2D::operator==(const Texture2D& v) const { return v.m_texture == m_texture; }
bool Texture2D::operator!=(const Texture2D& v) const { return v.m_texture != m_texture; }
bool Texture2D::valid() const { return m_texture != nullptr; }
ID3D11Texture2D* Texture2D::ptr() { return m_texture.get(); }
...
TextureFormat GetMRFormat(DXGI_FORMAT f)
{
    ...
    case DXGI_FORMAT_B8G8R8A8_UNORM: return TextureFormat::BGRAu8;
    case DXGI_FORMAT_R16_FLOAT: return TextureFormat::Rf16;
    case DXGI_FORMAT_R16G16B16A16_FLOAT: return TextureFormat::RGBAf16;
    case DXGI_FORMAT_R32_FLOAT: return TextureFormat::Rf32;
    case DXGI_FORMAT_R32G32B32A32_FLOAT: return TextureFormat::RGBAf32;
